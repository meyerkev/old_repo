...
* All other functions and operators either leave the allocation unchanged from the source dat
...
public:
	...
	/* *** Here, declare the copy constructor, destructor, and assignment operators.
	   ...
	   The move constructor takes the original's data, and replaces with values like those 
	   of a default constructed object

	   Assignment operators: 
	   If the right-hand side is a C-string, "construct and swap" is used to initialize
	   this String with a minimum allocation that holds the data. 
	   Copy assignment from a String object results in a copy of the right-hand-side data
	   with minimum allocation, and uses the copy-swap idiom.
	   Move assignment from a String object simply swaps with right-hand-side.
	*/
	...
	const char * c_str() const	
		{/* fill this in */}
	// Return size of internal C-string
	int size() const
		{/* fill this in */}
...
// This function constructs a copy of the lhs, then concatenates the rhs to it and returns it.
