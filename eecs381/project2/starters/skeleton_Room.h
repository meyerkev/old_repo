...
public:
    ...
    // Let the compiler supply default destruction, copy and move construction, copy and move assignment
	...
	/* *** fill here in what do you need to declare for the output operator */

private:
	/* *** the meeting information must be kept in a container of Meeting objects */
	typedef Ordered_list<Meeting> Meetings_t;
	Meetings_t meetings;
