...
public class clockReal
{
	public static void main(String[] args){
		...
		//set them equal
		int counter = 0;
		if(c1.equalsIgnoreAM(c2)){
			System.out.println("The clocks are already equal at: " + c1.toStringIgnoreAM());
		}else if(s1 == s2 && !c1.equalsIgnoreAM(c2)){
			...
			}while(!c1.equalsIgnoreAM(c2));
			System.out.println("The clocks will be equal at: " + c1.toStringIgnoreAM());
		}
	}
}
